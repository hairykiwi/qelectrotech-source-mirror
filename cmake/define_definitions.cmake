...
if(DEFINED QET_COMMON_COLLECTION_PATH_RELATIVE_TO_BINARY_PATH_VAR)
  if(${QET_COMMON_COLLECTION_PATH} STRGREATER "")
    message("QET_COMMON_COLLECTION_PATH " ${QET_COMMON_COLLECTION_PATH} " (relative to binary)")
    add_definitions(-DQET_COMMON_COLLECTION_PATH=${QET_COMMON_COLLECTION_PATH})
  endif()
  if(${QET_COMMON_TBT_PATH} STRGREATER "")
    message("QET_COMMON_TBT_PATH        " ${QET_COMMON_TBT_PATH} " (relative to binary)")
...
if(DEFINED QET_LANG_PATH_RELATIVE_TO_BINARY_PATH_VAR)
  if(${QET_LANG_PATH} STRGREATER "")
    message("QET_LANG_PATH              " ${QET_LANG_PATH} " (relative to binary)")
