...
if(APPLE)
  ...
  if(CMAKE_BUILD_TYPE STREQUAL "Debug")
    # Development build: use paths relative to binary for running from build dir
    set(QET_COMMON_COLLECTION_PATH  "elements/")
    set(QET_COMMON_TBT_PATH         "titleblocks/")
    set(QET_LANG_PATH               "lang/")
    add_compile_definitions(QET_COMMON_COLLECTION_PATH_RELATIVE_TO_BINARY_PATH)
    add_compile_definitions(QET_LANG_PATH_RELATIVE_TO_BINARY_PATH)
    set(QET_COMMON_COLLECTION_PATH_RELATIVE_TO_BINARY_PATH_VAR ON)
    set(QET_LANG_PATH_RELATIVE_TO_BINARY_PATH_VAR ON)
  else()
    # Release/bundle build: use standard macOS app bundle paths
